...
{
	InitVertex(_pos, &D3DXVECTOR2(200, 64), "e_fan", &m_Vertex);
...
void FantasticText::InitVertex(D3DXVECTOR2* _pos, D3DXVECTOR2* _rect, LPCTSTR _animName, Vertex* _vertex)
{
	_vertex->Pos = *_pos;
	_vertex->Rect = *_rect;
...
void FantasticText::ReleaseVertex(Vertex* _vertex)
{
