...
const D3DXVECTOR2 HpGaugeUI::m_Rect = D3DXVECTOR2(240,96);
...
m_TextureIndex(_textureIndex)
{
	...
	{
		m_pHpIcon[i] = new HpIcon(m_TextureIndex, &D3DXVECTOR2(static_cast<FLOAT>((m_Pos.x - (75 * 1.2)) + (75 * 0.5)* i), m_Pos.y));
	}
